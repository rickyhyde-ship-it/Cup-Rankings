/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 165a5612e6f96ef8bc2170ab586b6690)
...
interface __BaseEnv_Env {
	...
	ADMIN_TOKEN: string;
	GITHUB_TOKEN: string;
	SCANNER: DurableObjectNamespace<import("./src/worker").RankingScanner>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "RankingScanner";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MFL_API_BASE" | "GITHUB_REPOSITORY" | "GITHUB_BRANCH" | "SYNC_GITHUB" | "ADMIN_TOKEN" | "GITHUB_TOKEN">> {}
}
